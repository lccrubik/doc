...
\footnotetext{Se conoce como \emph{Receta} a cualquier secuencia de movimientos de las caras del cubo. Por ejemplo \bold{RFlrUdbUU}}
...
De hecho, dado un cubo de entrada, los números centrales de cada cara nunca cambian (¿por qué?), por lo que sería imposible resolverlo si requerimos que quede igual al ejemplo. % ponemos esto o no? agregamos las rotaciones o no? si ponemos rotaciones estamos mintiendo con lo segundo
